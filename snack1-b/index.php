...
// soluzione senza duplicazione dei dati
do {
    $randomIndex = rand(0, count($ads) - 1);
} while ($ads[$randomIndex]['is_active'] == false);

$randomAds = $ads[$randomIndex];


/*
//pezzo di codice da decommentare per tutte le soluzione sotto
...
/*
// logica "Naiva" fatta a mano
$randomIndex = rand(0, count($activeAds) -1 );
$randomAds = $activeAds[$randomIndex];
/*

/*
// usando la array_rand
$randomIndex = array_rand($activeAds);
$randomAds = $activeAds[$randomIndex];
*/
...
// usando la shuffle
shuffle($activeAds);
$randomAds = $activeAds[0];
*/

echo "<a href='" . $randomAds['link'] . "' ><img src='" . $randomAds['image_path'] . "' /></a>";